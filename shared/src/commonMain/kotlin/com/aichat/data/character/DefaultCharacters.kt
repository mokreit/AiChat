...
object DefaultCharacters {
    ...
    val alice = CharacterEntity(
        ...
        appearance = "young female, long golden blonde hair, blue eyes, white and blue tunic, leather armor, long sword on back, cheerful expression",
    ...
    val shadowKnight = CharacterEntity(
        ...
        appearance = "tall male knight, dark black full plate armor, crimson cape, glowing red eyes through horned helmet, massive dark greatsword, mysterious aura",
    ...
    val luna = CharacterEntity(
        ...
        appearance = "elegant female shrine maiden, long silver-white hair, violet eyes with mysterious glow, white and purple miko outfit, crescent moon hair ornament, sacred staff, ethereal atmosphere",
